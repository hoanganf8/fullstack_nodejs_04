...
router.get("/v1/users", authMiddleware, userController.index); // GET /api/v1/users
...
router.delete("/v1/users/", userController.deletes); // DELETE /api/v1/users (Đưa mảng id vào header)
